...
.admin-payout-actions {display:inline-flex;gap:5px;}.admin-payout-actions button {border:0;background:none;color:#087b5c;cursor:pointer;font:600 11px "Poppins";padding:0;}.admin-payout-actions button:last-child {color:#a34638;}.admin-delete-referral button {color:#a34638;}.admin-referral-groups {display:grid;gap:18px;}.admin-referral-group {overflow:hidden;}.admin-referral-group-heading {display:flex;justify-content:space-between;align-items:center;gap:18px;padding:18px;border-bottom:1px solid #e6eee9;background:#f7fbf8;}.admin-referral-group-heading strong,.admin-referral-group-heading small {display:block;}.admin-referral-group-heading small {margin-top:4px;color:#819089;font-size:11px;}.admin-referral-group-heading > span {color:#587067;font-size:12px;white-space:nowrap;}
